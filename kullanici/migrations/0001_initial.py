    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, unique=True, validators=[kullanici.models.email_validator], verbose_name='email address')),
                ...
                ('il', models.CharField(max_length=40)),
                ('ilce', models.CharField(max_length=40)),
                ('phone', models.CharField(max_length=12, unique=True, validators=[kullanici.models.phone_validator])),
